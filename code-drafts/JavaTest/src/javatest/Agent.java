...
public class Agent {
    ...
    private static double DIST_SCALE;
    private static double VELOCITY;
    
    
    private final int id;           // index for the agent
    private double[] pos;           // position
    private double[] vel;           // velocity - used for gravity wells
    ...
    */
     ...
     * we then scale 1/d (the distance) by the DIST_SCALE
     * and return
     *
    ...
    public double perceptionStrength(Agent query) {
        ...
        if (!visible(query)) { return 0.0; }
            ...
            // we now return the perception strength: DIST_SCALE / dist_sqrd
            return DIST_SCALE / dist_sqrd;
        }
    }
        
    /* method to update the pos and orientation of the agent */
    ...
    public static void setDistScale(double dist_scale) { DIST_SCALE = dist_scale; }
    ...
    private void drawCircle(Graphics g) {
        ...
        g2d.setPaint(JavaTest.getDefaultColor());       // reset paint color
    }
