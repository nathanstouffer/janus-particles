...
*  **singlesim.py** - Use this script to run a single instance of the agent simulation. Initial conditions are hardcoded in the file. With flag *-p,* output will be put in *../data/.* Any other flag will cause the output to be in *../data/tmp/* (eg *python singlesim.py -p* or *python singlesim.py -t*).
